...
namespace Product_Management_sys_MVC.Controllers
{
    [Authorize]
    public class ProductsController : Controller
    {
        ...
        {
            var productDbContext = _context.Product.Include(p => p.Brand).Include(p => p.Category);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Categoryid,Brandid,Qty,Price")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Categoryid,Brandid,Qty,Price")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
